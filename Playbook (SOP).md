...
- On Sales Navigator: filter for people with **"years in current position < 1 year"** inside large accounts — recent hires are psychologically primed for change and are lower-hanging fruit than long-tenured employees (source: Morgan Ingram, *How to Use Sales Navigator Like a Pro*).
- Use the **"Connections of"** filter against people you're already connected to (execs, customers, partners) who previously worked at a target account, to source warm referral paths (source: Morgan Ingram, *How to Use Sales Navigator Like a Pro*).
- Build a standing list of every closed-won and closed-lost contact you've ever worked with — track when they change jobs, since that's a built-in pipeline flywheel (source: Morgan Ingram, *How to Use Sales Navigator Like a Pro*).
